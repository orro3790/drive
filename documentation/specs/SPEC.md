...
> ADRs in `documentation/adr/` contain decision rationale.
...
See `documentation/specs/data-model.md` for complete Drizzle schema.

## Appendix: Development Patterns

See `documentation/agent-guidelines.md` for implementation conventions.

## Appendix: Decision Records

- `documentation/adr/001-tech-stack.md` - Technology choices
- `documentation/adr/002-replacement-bidding-system.md` - Bidding vs FCFS decision
- `documentation/adr/003-scheduling-model.md` - Two-week lookahead rationale
